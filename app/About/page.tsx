    ...
    return (
        <main className='w-full mt-40'>
            <div className='p-4 md:p-8 flex flex-col gap-y-12 md:gap-y-8'>
                ...
                <p className="text-lg mt-28 text-green-800 break-words">
                ...
                {/* Religion section */}
                <h2 className="text-3xl md:text-4xl font-extrabold text-center text-green-900 mt-16">Religion</h2>
