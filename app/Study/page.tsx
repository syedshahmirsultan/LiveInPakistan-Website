...
const universitiesData = [
    ...
    {
        name:"3. COMSATS University Islamabad (CUI)",
    ...
    {
        name:"4. Lahore University of Management Sciences (LUMS)",
    ...
    {
        name:"5. University of the Punjab (PU)",
    ...
    {
        name:"6. University of Agriculture (UAF)",
    ...
    {
        name:"7. University of Engineering and Technology (UET)",
    ...
    {
        name:"8. Aga Khan University (AKU) ",
    ...
    {
        name:"9. Pakistan Institute of Engineering and Applied Sciences (PIEAS)",
    ...
    {
        name:"10. Institute of Space Technology (IST)",
    ...
    {
        name:"11. University of Karachi (UoK)",
    ...
    {
        name:"12. University of Lahore (UoL)",
    ...
    {
        name:"13. Bahauddin Zakariya University (BZU)",
    ...
    {
        name:"14. International Islamic University Islamabad (IIUI)",
    ...
    {
        name:"15. Government College University (GCU)",
    ...
    {
        name:"16. Khyber Medical University (KMU) ",
    ...
    {
        name:"17. Liaquat University of Medical and Health Sciences (LUMHS)",
    ...
    {
        name:"18. University of Sargodha (UOS)",
    ...
    {
        name:"19. Mehran University of Engineering and Technology (MUET) ",
        ...
        name:"20. University of Peshawar (UoP)",
    ...
    {
        name:"21. University of Health Sciences (UHS)",
    ...
    {
        name:"22. Dow University of Health Sciences (DUHS)",
    ...
    {
        name:"25. Fatima Jinnah Women University (FJWU)",
    ...
    {
        name:"26. Shaheed Zulfiqar Ali Bhutto Institute of Science and Technology (SZABIST)",
    ...
    {
        name:"29. University of Gujrat (UoG)",
    ...
    {
        name:"30. University of Sindh (SU)",
    ...
    {
        name:"31. Institute of Business Administration (IBA)",
    ...
    {
        name:"32. University of Malakand (UoM)",
    ...
    {
        name:"33. Air University",
        href:"https://www.au.edu.pk/",
        text:"Air University Pakistan, renowned for its excellence in aerospace and aviation education, holds a prominent position globally. It is highly regarded for its innovative programs in aeronautical engineering, aviation management, and space sciences. The university consistently ranks among the top institutions in Pakistan for its specialized focus on aerospace technologies and related disciplines. With its main campus located in Islamabad, Air University also extends its academic influence through branches in major cities like Multan and Kamra. These campuses serve as hubs for cutting-edge research and education, contributing significantly to Pakistan's aviation and aerospace sectors.",
        imageUrl:"/images/au.png"
    },
    {
        name:"34. Capital University of Science and Technology (CUST)",
    ...
    {
        name:"35. Foundation University Islamabad (FUI)",
    ...
    {
        name:"40. University of Azad Jammu and Kashmir (UAJK)",
    ...
    {
        name:"41. Sir Syed University of Engineering and Technology (SSUET)",
    ...
    {
        name:"42. National University of Computer and Emerging Sciences (FAST-NUCES)",
    ...
    {
        name:"47. Shifa Tameer-e-Millat University",
    ...
    {
        name:"48. Institute of Southern Punjab",
    ...
    {
        name:"49. Lahore College for Women University (LCWU)",
        ...
        imageUrl:"/images/lcwu.pn"
    },
    {
        name:"50. Ghulam Ishaq Khan Institute of Engineering Sciences and Technology (GIKI)",
    ...
    <div className="mt-20">
{
 ...
 <div className='flex flex-col gap-y-8'>
    ...
    <Link href={item.href}> <button className="bg-green-950 hover:text-green-900 animate-bounce px-6 py-3 text-center font-semibold text-white">Visit Site</button></Link>
        </div>
