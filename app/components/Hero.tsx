    ...
    <div className='relative w-full h-screen overflow-hidden'>
      {imagesUrl.map((url, index) => (
        <Image
          ...
          width={500}
          height={500}
          className={`md:object-fit object-cover absolute top-0 left-0 w-full h-[200px] md:h-full transition-opacity duration-1000 ease-in-out ${index === currentImageIndex ? 'opacity-100' : 'opacity-0'}`}
