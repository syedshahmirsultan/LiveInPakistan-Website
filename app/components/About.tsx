...
const About = () => {
    return (
     ...
     About
        ...
        {/* Button */}
        <Link href="/About" className=' flex justify-center'><button className=" rounded-md mt-6 md:mt-8 flex justify-center px-6 py-3  text-sm font-semibold text-white hover:bg-green-900 bg-green-950 animate-bounce duration-500">Read More</button></Link>
        </div>
        </section>
    );
}
